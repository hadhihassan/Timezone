...
const dateErrorMessge = document.getElementById("dateErrorMessgae")
...
function imageValidation() {
    const img = imageInput.files.length
    if (img < 3) {
...
function dateValidation() {
    ...
    if (!datePattern.test(dateValue)) {
        dateErrorMessge.innerHTML = "Date of Release is required ...";
        return false;
    } else {
        dateErrorMessge.innerHTML = ""
        return true
    }
}
